...
EXPECTED_ACCOUNT_ID=""
STACK_NAME="package-scanner-r-ecs-dev"
...
LINUX_AMD64_INSTANCE_TYPE="m7i.large"
LINUX_ARM64_INSTANCE_TYPE="m7g.large"
...
usage() {
  cat <<'EOF'
Usage: deploy-r-ecs-cfn.sh [options]
...
TEMPLATE_PATH="${REPO_ROOT}/deployment/cfn/ecs-scan-stack.yaml"
...
echo "Deploying R ECS stack ${STACK_NAME} in ${REGION} ..."
aws cloudformation deploy \
  ...
  --tags \
    ...
    "Purpose=cyber-package-scanning-r-ecs-worker-plane" \
